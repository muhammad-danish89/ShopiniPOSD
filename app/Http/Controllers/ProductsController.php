...
class ProductsController extends BaseController
{
    ...
    public function import_products(Request $request)
    {
       // try {
          /*  \DB::transaction(function () use ($request) {
                ...
                if ($ext != 'csv') {
                    ...
                    if (($handle = fopen($file_upload, "r")) !== false) {
                        ...
                        $max_line_length = defined('MAX_LINE_LENGTH') ? MAX_LINE_LENGTH : 500000000;
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        $Product->code = mt_rand(1000000000, 9999999999);
		...
		//	325547 - 321,047  566983 .446936
			
			ini_set('max_execution_time', 998000000);
			for($i=446936;$i<=566983; $i++){
				
				$warehouses=1;
			/*	$Product = new Product;
                        $Product->name = "Product-A".$i;
                        $Product->code = mt_rand(1000000000, 9999999999);
                        $Product->Type_barcode = 'CODE128';
                        $Product->price = 1020+$i;
                        $Product->cost =  1020+$i;
