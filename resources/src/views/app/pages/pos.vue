<template>
  <div class="pos_page">
                      ...
                      <validation-provider name="Customer" :rules="{ required: true}">
                        <b-input-group slot-scope="{ valid, errors }" class="input-customer">
                          <v-select
                            ...
                            class="w-100"
                            :options="clients.map(clients => ({label: clients.name+' -'+clients.phone, value: clients.id}))"
                          />
	...
	<!-- City -->
                    ...
                    <b-col lg="12" md="12" sm="12">
					 <b-form-group :label="$t('If You want Delivery Order anyother Address')" label-class="font-weight-bold pt-15"
      class="mb-15"></b-form-group>
...
<b-col lg="12" md="12" sm="12" class="mt-2">
                      <b-form-group :label="$t('Delivery Address')">
                        <b-form-input
                          id="input"
