 ...
 */
 ...
 Route::get('app/online', 'PosController@Getaccess');

Route::get('api/getCountries', 'APIController@getCountries');
Route::get('api/getStates', 'APIController@getStates');
Route::get('api/getshippings', 'ShippingController@index');
...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
 ...
 //---------------------- API My (point of sales) ----------------------\\
    //------------------------------------------------------------------\\

    Route::resource('Api', 'ApiController');
    Route::get('shipping', 'ApiController@GetShipping');
    Route::get('pos/GetELementPos', 'PosController@GetELementPos');
    //------------------------------- PRODUCTS --------------------------\\
    //------------------------------------------------------------------\\
 ...
 //------------------------------- Shipping --------------------------\\
	...
	Route::get('Get_Shipping/All', 'ShippingController@Get_Shippings');
     Route::post('online', 'ShippingController@OnlineShoini');
	Route::get('PushOrders', 'ShippingController@OnlineSync');

    Route::post('shipping/delete/by_selection', 'ShippingController@delete_by_selection');
