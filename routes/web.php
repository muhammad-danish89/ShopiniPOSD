 ...
 */
 ...
 Route::get('app/online', 'ShippingController@OnlineShoini');
 Route::get('app/offline', 'ShippingController@Offline');
  Route::get('app/send_data', 'ShippingController@OnlineSync');
